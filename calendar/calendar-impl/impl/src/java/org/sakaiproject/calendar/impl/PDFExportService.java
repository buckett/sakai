...
public class PDFExportService {
     ...
     * @param baseCalendarService
     */
    protected List makeListViewTimeRangeList(TimeRange timeRange, List calendarReferenceList, BaseCalendarService baseCalendarService)
    {
     ...
     * @param endDay
     */
    protected static long getNumberDaysGivenTwoDates(int startYear, int startMonth, int startDay, int endYear, int endMonth, int endDay)
    {
